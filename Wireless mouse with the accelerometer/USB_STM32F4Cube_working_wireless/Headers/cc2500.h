...
#define CC2500_SPI_SCK_PIN               GPIO_PIN_13		                /* PE2 */
#define CC2500_SPI_SCK_GPIO_PORT         GPIOB                       /* GPIOE */

#define CC2500_SPI_MISO_PIN              GPIO_PIN_14               	 /* PE5 */
#define CC2500_SPI_MISO_GPIO_PORT        GPIOB                       /* GPIOE */

#define CC2500_SPI_MOSI_PIN              GPIO_PIN_15                 /* PE6 */
#define CC2500_SPI_MOSI_GPIO_PORT        GPIOB                       /* GPIOE */


#define CC2500_SPI_NSS_PIN                GPIO_PIN_12                  /* PE3 */
#define CC2500_SPI_NSS_GPIO_PORT          GPIOB                     /* GPIOE */



#define CC2500_FLAG_TIMEOUT         ((uint32_t)0x1000)
#define CC2500_NSS_LOW()       HAL_GPIO_WritePin(CC2500_SPI_NSS_GPIO_PORT, CC2500_SPI_NSS_PIN, GPIO_PIN_RESET)
#define CC2500_NSS_HIGH()      HAL_GPIO_WritePin(CC2500_SPI_NSS_GPIO_PORT, CC2500_SPI_NSS_PIN, GPIO_PIN_SET)
